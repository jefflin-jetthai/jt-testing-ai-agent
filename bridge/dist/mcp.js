 ...
 */
export function writeBrowserMcpConfig() {
...
export function writeMcpConfig(browserUrl = CDP_BROWSER_URL) {
...
export async function probeCdp(browserUrl = CDP_BROWSER_URL) {
    try {
